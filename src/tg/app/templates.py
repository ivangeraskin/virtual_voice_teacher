...
message_topics = "Пожалуйста, выберите тему, после чего запишите голосовое:\n- Как Вы провели последний отпуск\n- Самый большой успех в жизни\n- О трудности, которую удалось преодолеть\n- О своих хобби, чем именно они так нравятся\n- О своем идеальном дне"
